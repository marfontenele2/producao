<template>
  <div class="dashboard-container">
    <header class="dashboard-header">
      <h1>Painel de Entregas - Produção Mensal</h1>
      <div class="filters-container">
        ...
        <div class="filter-group">
          ...
          <input
            type="month"
            id="competencia"
            :value="store.competenciaAtual"
            @input="store.setCompetencia($event.target.value)"
...
import { useStatusCoordenadorStore } from "@/store/statusCoordenadorStore.js";
import MultiSelectDropdown from "@/components/shared/MultiSelectDropdown.vue"; // ✅ Importa o novo componente

const store = useStatusCoordenadorStore();
