// 📄 ARQUIVO GERADO: src/services/mddaService.js
import { db } from "@/firebase";
import { doc, setDoc, onSnapshot, getDoc } from "firebase/firestore";

const COLLECTION_NAME = "producaoMDDA";

const estruturaVazia = {
  microareas: [], // Será um array de objetos, cada um com os dados da linha
  obitos: { "<1": null, "1-4": null, "5-9": null, "10+": null, Ing: null },
  ocorreuObito: null, // 'sim' ou 'nao'
  finalizado: false,
};

export const mddaService = {
