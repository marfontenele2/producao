<template>
  <div class="secao-dados">
    <div class="cabecalho-secao">
      ...
      <button type="button" class="botao botao-acao" @click="adicionarItem">
    ...
    <table class="tabela-padrao tabela-perdas">
      ...
      <tbody>
        <tr v-if="!itens || itens.length === 0">
          <td :colspan="comMotivo ? 4 : 3" class="sem-registros">Nenhum item adicionado.</td>
        </tr>
        <tr v-for="(item, index) in itens" :key="index">
          ...
          <td>
            <button type="button" class="botao-acao excluir" @click="removerItem(index)">
              <Trash2 :size="16" />
            </button>
          </td>
        </tr>
